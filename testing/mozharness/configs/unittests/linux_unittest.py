...
config = {
    ...
    "all_reftest_suites": {
        "reftest": { 'options': ["--suite=reftest"],
                     'tests': ["tests/reftest/tests/layout/reftests/reftest.list"] },
        "crashtest": {  'options': ["--suite=crashtest"],
        ...
        "reftest-no-accel": {'options': ["--suite=reftest", '--setpref=layers.acceleration.force-enabled=disabled'],
                             'tests': ['tests/reftest/tests/layout/reftests/reftest.list']},
